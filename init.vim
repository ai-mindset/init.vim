...
" Telescope + which-key Configuration with mini icons
lua << EOF
-- Define custom icons using more commonly supported unicode characters
local icons = {
  File = "📄 ",    -- or use "● " if you prefer the simple version
  Search = "🔍 ",   -- or use "⌕ " if you prefer the simple version
  Git = "⎇ ",      -- or use 🌿 " if you prefer the emoji version
  Folder = "📁 ",   -- or use "▸ " if you prefer the simple version
  LSP = "⚡ "       -- or use "λ " if you prefer the simple version
}
...
-- Keep the minimal which-key setup
wk.setup({
  icons = {
    breadcrumb = "",
    separator = "",
